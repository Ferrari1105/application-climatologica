...
function Perfil() {
  ...
  <>
      ...
      <Card.Body>
        ...
        <Card.Text>
          Edad y Fecha de Nacimiento: 28 años, 15 de julio de 1995
        </Card.Text>
        <Card.Text>
          Correo Electronico: ana.rodriguez@example.com
        </Card.Text>
        <Card.Text>
          Descripcion: Estudiante universitaria interesada en la ciencia y la tecnología. Le gusta viajar y aprender sobre diferentes culturas.
        </Card.Text>
